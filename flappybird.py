...
game_images = {} 
framepersecond = 32
pipeimage = 'D:\\VS code\\python programs\\png\\pipe.png'
background_image = 'D:\\VS code\\python programs\\png\\background.jpg'
birdplayer_image = 'D:\\VS code\\python programs\\png\\bird.png'
sealevel_image = 'D:\\VS code\\python programs\\png\\base.png'
...
def flappygame(): 
    ...
    while True: 
        ...
        # Fill the window with a background color (black) before drawing
        window.fill((0, 0, 0))  
...
if __name__ == "__main__": 
    ...
    game_images['scoreimages'] = ( 
        pygame.image.load('D:\\VS code\\python programs\\png\\image0.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image0.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image2.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image3.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image4.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image5.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image6.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image7.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image8.png').convert_alpha(), 
        pygame.image.load('D:\\VS code\\python programs\\png\\image9.png').convert_alpha() 
    ) 

    # Load and scale the background image
    background_image = pygame.image.load(background_image).convert_alpha()
    background_image = pygame.transform.scale(background_image, (window_width, window_height))
    game_images['background'] = background_image
