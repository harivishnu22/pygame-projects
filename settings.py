...
SPRITE_DIR_PATH = 'D:\VS code\python programs\project game\sprites'
FONT_PATH = 'D:\VS code\python programs\project game\FREAKSOFNATUREMASSIVE.ttf'

ANIM_TIME_INTERVAL = 150  # milliseconds
FAST_ANIM_TIME_INTERVAL = 15

TILE_SIZE = 15
FIELD_SIZE = FIELD_W, FIELD_H = 20,20
